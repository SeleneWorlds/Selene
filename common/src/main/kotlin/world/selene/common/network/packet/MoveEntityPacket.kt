...
data class MoveEntityPacket(val networkId: Int, val start: Coordinate, val end: Coordinate, val duration: Float) : Packet {
    companion object {
        fun decode(buf: ByteBuf): MoveEntityPacket {
            ...
            return MoveEntityPacket(networkId, start, end, duration)
        }
